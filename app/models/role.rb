...
class Role < ApplicationRecord
  ...
  def self.create_default_roles(provider)
    ...
    Role.create(name: "student", provider: provider, priority: 2, colour: "#868e96")
        .update_all_role_permissions(can_create_rooms: false)
    Role.create(name: "teacher", provider: provider, priority: 3, colour: "#868e96")
            .update_all_role_permissions(can_create_rooms: true)
    Role.create(name: "admin", provider: provider, priority: 0, colour: "#f1c40f")
        .update_all_role_permissions(can_create_rooms: true, can_manage_school: true)
  ...
  def update_all_role_permissions(permissions = {})
    ...
    update_permission("can_manage_school", permissions[:can_manage_school].to_s)
  end
